...
@Component({
  ...
  template: `
    @if (sheet.isSheetOpen()) {
      <aside
        #sidebar
        class="fixed flex flex-col -left-full z-50 opacity-0 top-0 bottom-0 h-screen bg-card border-r-2 border-border md:w-87.5 sm:w-82 min-[450px]:w-76 w-full p-4"
      >
